## Aside from changing the data to fit only Baltimore and to open as plot2.png, this is identical to plot1.R

## Import the data using the suggested readRDS() function
NEI <- readRDS("Data/summarySCC_PM25.rds")
SCC <- readRDS("Data/Source_Classification_Code.rds")

## Trim the dataframe down to only include Baltimore data (given as fips = 24510 in the problem statement)
...
plot(years, year_pm2.5, pch = 16, xlab = "Year", ylab = "Total PM2.5 Pollution", main = "PM2.5 Pollution by Year in Baltimore, MD")
